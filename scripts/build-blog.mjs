...
<div style="width:100%;height:220px;overflow:hidden;border-bottom:1.5px dashed rgba(26,26,26,0.25);background:var(--cream);"><img class="post-hero" src="${heroImgSrc}" alt="" aria-hidden="true" loading="eager" decoding="async"></div>
<div class="post-wrap">
